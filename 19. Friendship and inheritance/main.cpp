...
//they are declared. However, this rule does not apply to "friends".

//Friends are functions or classed declared with the friend keyword.
...
//Typical use case of friend functions are operations that are conducted between two different classes accessing private
